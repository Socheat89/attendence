    ...
    <div class="flex items-center justify-between w-full pt-2">
        <div class="flex flex-col">
            ...
            <p class="text-slate-500 text-sm mt-1 ml-14 group flex items-center gap-1.5">
                <span class="w-1.5 h-1.5 rounded-full bg-slate-300"></span> Editing "{{ $subscriptionPlan->name }}"
            </p>
        </div>
    </div>
@endsection
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $subscriptionPlan->name) }}" required
                            class="block w-full px-4 py-3 border border-slate-200 rounded-xl leading-5 bg-slate-50 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 sm:text-sm transition-all text-slate-900 font-bold"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $subscriptionPlan->price) }}" required
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <label for="is_active" class="text-sm font-semibold text-slate-700 select-none">Active Status</label>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="employee_limit" id="employee_limit" value="{{ old('employee_limit', $subscriptionPlan->employee_limit) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="branch_limit" id="branch_limit" value="{{ old('branch_limit', $subscriptionPlan->branch_limit) }}"
                            class="block w-full px-4 py-3 border border-slate-200 rounded-xl leading-5 bg-slate-50 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 sm:text-sm transition-all"
                            placeholder="Leave empty for unlimited">
